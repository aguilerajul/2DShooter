...
public class Health : MonoBehaviour
{
    ...
    [Tooltip("The life to be display it")]
    public Slider lifeSlider;

    [Tooltip("The name of the layer in order to be displayed in the scene")]
    public string sortingLayerName;

    void Awake()
    {
        var lifeCanvas = GetComponentInChildren<Canvas>();
        if (lifeCanvas != null)
        {
            lifeCanvas.sortingLayerName = sortingLayerName;
        }
    }
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        else
        {
            ...
            if (lifeSlider != null)
            {
                ...
                {
                    lifeSlider.value = (float)currentHealth / (float) maximumHealth;
                }
            }
            CheckDeath();
        }
